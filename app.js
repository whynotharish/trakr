...
function startEdit(tid) {
  ...
  <button class="delete-btn" data-action="edit-delete" style="opacity:0.5;margin-right:auto" title="Delete task"><svg viewBox="0 0 16 16" fill="none" stroke="var(--overdue)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M2 4h12M5.3 4V2.7a1 1 0 011-1h3.4a1 1 0 011 1V4M6.5 7v4.5M9.5 7v4.5"/><path d="M3.5 4l.7 8.3a1.5 1.5 0 001.5 1.4h4.6a1.5 1.5 0 001.5-1.4l.7-8.3"/></svg></button>
